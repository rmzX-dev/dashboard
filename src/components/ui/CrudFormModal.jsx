...
export default function CrudFormModal({ formSchema, onSubmit, editingItem = null, open: externalOpen = false, onClose: externalOnClose = null }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // El error ya se maneja en useResource con toast
    }
  };
              ...
              {formSchema.map((field) => (
                <div key={field.name} className="flex flex-col">
                  ...
                  <input
                    ...
                    required={isEditing ? field.required && !field.skipOnEdit : field.required}
                    onChange={handleChange}
                    step={field.step}
                    placeholder={isEditing && field.skipOnEdit ? "Dejar vacío para no cambiar" : ""}
